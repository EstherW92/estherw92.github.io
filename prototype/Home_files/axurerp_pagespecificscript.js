...
var PageName = 'Home';
var PageId = '7aa64d1f4aaf4686aa6c51322f2c8ca6'
...
if (true) {
	...
	self.location.href="Zoekresultaten.html" + GetQuerystring();
...
if (true) {
	...
	SetPanelVisibility('u24','toggle','none',500);
...
if (true) {
	...
	MoveWidgetTo('u61', 3100,0,'linear',300);

	SetPanelVisibility('u61','toggle','none',500);
